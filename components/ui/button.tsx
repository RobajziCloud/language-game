...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant="default", ...props }, ref) => {
    ...
    const map = { default: "bg-emerald-500/90 hover:bg-emerald-500 text-white focus:ring-emerald-400 ring-offset-neutral-900",
                  secondary: "bg-white/10 hover:bg-white/20 text-white ring-offset-neutral-900"} as const;
